...
#define PATTERNS
	...
	extern char arp_fsprintf_buufer[];

	#define arp_fsprintf(parm_a, ...) {sprintf_P(arp_fsprintf_buufer, (PGM_P)PSTR(parm_a), ##__VA_ARGS__); Serial.print(String(arp_fsprintf_buufer));}
